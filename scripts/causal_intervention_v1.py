...
This script performs interchange interventions to identify which layers causally mediate cultural knowledge suppression in RLHF-aligned models.
...
Evaluation Metric: Answer entity probability - measures whether the correct answer appears in top-k predictions when processing knowledge-bearing sentences.
"""
